    ...
    private class FileListener extends FileAlterationListenerAdaptor {
        ...
        public void onFileCreate(File file) {
            ...
            try {
                ...
                com.alibaba.otter.canal.client.adapter.clickhouse.config.MappingConfig config = YamlUtils
                    .ymlToObj(null, configContent, com.alibaba.otter.canal.client.adapter.clickhouse.config.MappingConfig.class, null, envProperties);
                if (config == null) {
                    return;
                }
                config.validate();
        ...
        public void onFileChange(File file) {
            ...
            try {
                if (clickHouseAdapter.getRdbMapping().containsKey(file.getName())) {
                    // 加载配置文件
