...
public class MappingConfig implements AdapterConfig {
    ...
    public static class DbMapping implements AdapterMapping {
        ...
        private Map<String, String> sourcePk        = new LinkedHashMap<>(); // 源表主键字段
        private Map<String, String> targetPk        = new LinkedHashMap<>(); // 目标表主键字段
        private String              sql;                                     // 同步sql
        private String              targetSign;                              // 目标表sign字段
        ...
        public Map<String, String> getSourcePk() {
            return sourcePk;
        }

        public void setSourcePk(Map<String, String> sourcePk) {
